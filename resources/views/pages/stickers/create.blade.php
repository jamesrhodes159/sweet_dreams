                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="sticker_name"
                                        value="{{ $settings->sticker_name ?? '' }}" name="sticker_name"
                                        style="width: 100%;">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control" id="sticker_image" name="sticker_image"
                                        style="width: 100%;">
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="sticker_type" name="sticker_type" style="width: 100%;">
                                        ...
                                        <option value="free"
                                            {{ isset($settings) && $settings->sticker_type == 'free' ? 'selected' : '' }}>
                                            Free</option>
                                        <option value="premium"
                                            {{ isset($settings) && $settings->sticker_type == 'premium' ? 'selected' : '' }}>
                                            Paid</option>
                                        <option value="point_redeemed"
                                            {{ isset($settings) && $settings->sticker_type == 'point_redeemed' ? 'selected' : '' }}>
                                            Points Redeemable</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="number" step="0.01" id="price"
                                        value="{{ $settings->price ?? '' }}" name="price" style="width: 100%;"
    ...
    <script>
        document.getElementById('sticker_image').addEventListener('change', function() {
            ...
            if (!allowedExtensions.exec(filePath)) {
                ...
                // If the file is valid, show a preview
